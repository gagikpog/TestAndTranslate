...
"}"));
        pushButton = new QPushButton(SettingsForm);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(130, 210, 131, 41));
    ...
    void retranslateUi(QDialog *SettingsForm)
    {
        ...
        pushButton->setText(QApplication::translate("SettingsForm", "PushButton", Q_NULLPTR));
    } // retranslateUi
